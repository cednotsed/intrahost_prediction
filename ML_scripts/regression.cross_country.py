...
# Export results
merged.to_csv(results / f'shap_out/train.{dataset}.shap.csv', index=0)
plt.savefig(results / f'beeswarm_out/{dataset}.cross_country.pdf', bbox_inches='tight')
...
# Export results
merged.to_csv(results / f'shap_out/{dataset}.cross_country.shap.csv', index=0)
plt.savefig(results / f'beeswarm_out/{dataset}.cross_country.pdf', bbox_inches='tight')
