...
file_dir <- "results/pipeline_out.tonkin/codon_out/"
...
fwrite(parsed_merged, "results/allele_frequency_out/codon_out/tonkin/tonkin.codon_freq.all.raw.csv.gz")
...
fwrite(parsed_agg, "results/allele_frequency_out/codon_out/tonkin/tonkin.codon_freq.all.summed.csv.gz")
...
fwrite(parsed_filt, "results/allele_frequency_out/codon_out/tonkin/tonkin.missense_freq.filt.csv.gz")
