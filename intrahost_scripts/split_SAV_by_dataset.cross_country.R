...
fwrite(dataset_temp, str_glue("results/allele_frequency_out/codon_out/early.non_US.raw.filt.csv"))
fwrite(dataset_agg, str_glue("results/allele_frequency_out/codon_out/early.non_US.csv"))
...
fwrite(dataset_temp, str_glue("results/allele_frequency_out/codon_out/{d}.US_only.raw.filt.csv"))
fwrite(dataset_agg, str_glue("results/allele_frequency_out/codon_out/{d}.US_only.csv"))
