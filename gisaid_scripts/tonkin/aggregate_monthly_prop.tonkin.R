...
fwrite(before, str_glue("results/allele_frequency_out/observed_out/before_tonkin.aggregate.csv"))
fwrite(future, str_glue("results/allele_frequency_out/observed_out/after_tonkin.monthly.csv"))
fwrite(future_agg, str_glue("results/allele_frequency_out/observed_out/after_tonkin.aggregate.csv"))
fwrite(current_agg, str_glue("results/allele_frequency_out/observed_out/during_tonkin.aggregate.csv"))
